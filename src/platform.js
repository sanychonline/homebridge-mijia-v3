...
const CAMERA_DEFAULTS = Object.freeze({
  'mijia.camera.v3': Object.freeze({
    ...
    liveFastStartSubStream: false,
    liveUseSubStreamForHomeKit: false,
    livePreconnect: false,
    livePreconnectIdleTimeoutMs: 45000,
    liveSubMaxBitrateKbps: 0,
    liveReaderRestartAttempts: 2,
    liveReaderRestartDelayMs: 300,
    liveMinVideoBitrateKbps: 1200,
    ...
    motionAnalysisConsecutiveFrames: 2,
    motionAnalysisDifference: 5,
    motionAnalysisFps: 2,
    motionAnalysisHeight: 90,
    motionAnalysisSensitivity: 98.5,
